...
public class FavoritesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set loading message while the user waits
        ArrayList<String> loadingMsg = new ArrayList<>();
        loadingMsg.add("Loading Favorites, please wait...");
        FavoritesListArrayAdapter msgAdapter = new FavoritesListArrayAdapter(loadingMsg, FavoritesActivity.this);
        favorites = (ListView) findViewById(R.id.favorites);
        favorites.setAdapter(msgAdapter);
    ...
    public void displayFavorite(View view) {
        ...
        if (verseTitle.equals("You have no Favorites saved yet.") || verseTitle.equals("Loading Favorites, please wait...")) {
            return;
        }
    ...
    private void populateFavoritesList() {
        ...
        Response.Listener<String> responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response.equals("No favorites")) {
                    // set "no favorites" message in adapter list
                    ArrayList<String> noFavMsg = new ArrayList<>();
                    noFavMsg.add("You have no Favorites saved yet.");
                    FavoritesListArrayAdapter msgAdapter = new FavoritesListArrayAdapter(noFavMsg, FavoritesActivity.this);
                    favorites.setAdapter(msgAdapter);
                    ...
                    Toast toast = Toast.makeText(getApplicationContext(), "You have " + favoritesArray.length + " Favorites saved.", Toast.LENGTH_LONG);
                    toast.show();
        ...
        loadFavoritesRequest.setRetryPolicy(new DefaultRetryPolicy(0, DefaultRetryPolicy.DEFAULT_MAX_RETRIES, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
